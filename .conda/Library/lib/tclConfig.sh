...
# installed.
TCL_PREFIX='c:/kc_new_ssd/client_works/elibraryplatform/.conda\Library'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='c:/kc_new_ssd/client_works/elibraryplatform/.conda\Library\bin'
...
# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='c:/kc_new_ssd/client_works/elibraryplatform/.conda\Library\lib\tcl86t.lib'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-Ic:/kc_new_ssd/client_works/elibraryplatform/.conda\Library\include'
...
# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-Lc:/kc_new_ssd/client_works/elibraryplatform/.conda\Library\lib tclstub86.lib'
...
TCL_STUB_LIB_PATH='c:/kc_new_ssd/client_works/elibraryplatform/.conda\Library\lib\tclstub86.lib'
